  ...
  return (
    <section className="w-full pt-10 md:pt-0 h-auto md:h-[35em] flex flex-col md:flex-row  items-center">
      <div className="w-full md:w-1/2 h-full flex flex-col justify-center py-12 sm:py-20 sm:mt-10 gap-6 md:gap-10 px-4 md:px-8 lg:px-16">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-5xl lg:text-6xl leading-snug sm:leading-tight md:leading-tight lg:leading-tight tracking-tighter font-bold font-[Volkhov] text-[#181E4B] sm:mt-12 md:mt-16 ">
          Travel,{" "}
          <span
            style={{
        ...
        <p className="w-full md:w-[90%] font-md text-sm md:text-base lg:text-lg text-[#5E6282] leading-relaxed md:leading-normal">
